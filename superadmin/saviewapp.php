...
<!-- ##### Header Area Start ##### -->
	...
	<table class="table1">
			...
			<?php
				//$uid=$_SESSION["u_id"];
				$result = mysql_query("SELECT * FROM applyloan where startdate='0000-00-00'")or die(mysql_error());
			...
			<tr>
				...
				{
					?>
					<br/><a href="saloanview.php?sd=1&lid=<?php echo $row['loan_id'];?>"  class="ubtn">Add Start Date</a>
				<?php
				}
					?>
				</td>
